...
class TrendingGenreMusicController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
		self.title = "Trending Music in Rap"
	...
	func getData(){
		...
		client.getGenreTrendingMusic(genre: "Rap") { (result) in
			switch result{
