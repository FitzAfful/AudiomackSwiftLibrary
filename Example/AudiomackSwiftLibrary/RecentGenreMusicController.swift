...
class RecentGenreMusicController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
		self.title = "Recent Music in Rap"
	...
	func getData(){
		...
		client.getGenreMostRecentMusic(genre: "Rap") { (result) in
			switch result{
